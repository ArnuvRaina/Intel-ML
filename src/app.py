...
def chat_with_dataset(df):
    st.subheader("Chat with Adult Census Income Dataset ")
...
def main_app(df, df2):
    ...
    logreg_model = LogisticRegression(C=1.0,class_weight='balanced')
    ...
    st.sidebar.link_button("Download Raw CSV File", "https://drive.google.com/file/d/1toTVZXSR3d0Vquna1p8DwjdL-8yvRBQT/view?usp=drive_link")
    st.sidebar.link_button("Download .ipynb Notebook", "https://drive.google.com/file/d/1zuXwu0qyFkd5CUr1SQCl7MlqL2wr4hyt/view?usp=drive_link")
    st.sidebar.link_button("Download Project Report", "https://drive.google.com/file/d/1BIxZPls1mO-_Up-Jt2n5KzyE-ekkU2Ge/view?usp=drive_link")

    st.sidebar.markdown("---")
    st.sidebar.markdown(
    """ If you have any questions, feel free to <a href="mailto:arnuvraina@gmail.com">Send me an email</a>.
...
# Main Streamlit app
st.header(' :blue[INTEL] ML PROJECT BY **:red[ THE SEMICOLONS]** ')
